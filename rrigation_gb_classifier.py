...
file="data.csv"
df=pd.read_csv(file)
st.title("Irrigation Pump Prediction Model with Gradient Boosting Classifier")
...
# Hyperparameter tuning: Allow users to change the number of estimators in the Gradient Boosting model
